...
describe('Login page tests', () => {
    describe('Check login problem user with a valid password', () => {
        it('Enter saucedemo.com', () => {
            LoginPage.open();
        });

        it('Enter a problem user and a valid password', () => {
    ...
    describe('Check login problem user without password', () => {
        it('Enter saucedemo.com', () => {
            LoginPage.open();
        });

        it('Enter a problem user and no password', () => {
            LoginPage.problemUsername();
    ...
    describe('Check login problem user with a blank space for password', () => {
        it('Enter saucedemo.com', () => {
            LoginPage.open();
        });

        it('Enter a problem user and a blank space for password', () => {
            LoginPage.problemUsername();
    ...
    describe('Check login problem user with numbers for passwords', () => {
        it('Enter saucedemo.com', () => {
            LoginPage.open();
        });

        it('Enter a problem user and numbers for password', () => {
            LoginPage.problemUsername();
    ...
    describe('Check login problem user with an invalid password', () => {
        it('Enter saucedemo.com', () => {
            LoginPage.open();
        });

        it('Enter a problem user and a wrong password', () => {
            LoginPage.problemUsername();
